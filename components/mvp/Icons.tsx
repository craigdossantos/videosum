...
export const ZoomIcon = ({ className }: { className?: string }) => (
    <svg viewBox="0 0 24 24" fill="currentColor" className={className}><path d="M4.5 5C3.67157 5 3 5.67157 3 6.5V17.5C3 18.3284 3.67157 19 4.5 19H13.5C14.3284 19 15 18.3284 15 17.5V6.5C15 5.67157 14.3284 5 13.5 5H4.5ZM17 8.5L21 6.5V17.5L17 15.5V8.5Z" /></svg>
);
